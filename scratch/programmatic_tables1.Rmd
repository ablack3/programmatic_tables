...
library(dplyr)
```
**Much of this worksheet is copied directly from the gt intro vignette**
...
To turn a dataframe into a display table we pass `islands_tbl` to the *function* `gt()` and we get a **gt Table** as output. 
